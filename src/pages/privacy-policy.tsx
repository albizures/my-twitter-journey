export default function PrivacyPolicy() {
	return (
		<>
			...
			<p>
				Jose Albizures built the My Twitter Journey app as an Open
				Source app. This SERVICE is provided by Jose Albizures at no
			...
			<p>
				...
				as in our Terms and Conditions, which are accessible at My
				Twitter Journey unless otherwise defined in this Privacy
				Policy.
			</p>
			<p>
			...
			<p>
				...
				information, including but not limited to Twitter public data.
			...
			<div>
				<p>
					...
					information from children. I encourage all children to never
					submit any personally identifiable information through the
					Application and/or Services. I encourage parents and legal
					guardians to monitor their {"children's"} Internet usage and
					to help enforce this Policy by instructing their children
					never to provide personally identifiable information through
					the Application and/or Services without their permission. If
					you have reason to believe that a child has provided
					personally identifiable information to us through the
					Application and/or Services, please contact us. You must
					also be at least 16 years of age to consent to the
					processing of your personally identifiable information in
