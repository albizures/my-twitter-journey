	...
	return (
		<>
			...
			<p>
				...
				related to it, still belong to Jose Albizures.
			</p>
			<p>
				Jose Albizures is committed to ensuring that the app is as
			...
			<p>
				The My Twitter Journey app stores and processes personal data
				...
				security features and it could mean that the My Twitter
				Journey app won’t work properly or at all.
			</p>
			<p>
				You should be aware that there are certain things that Jose
				Albizures will not take responsibility for. Certain functions
				of the app will require the app to have an active internet
				connection. The connection can be Wi-Fi or provided by your
				mobile network provider, but Jose Albizures cannot take
			...
			<p>
				Along the same lines, Jose Albizures cannot always take
				responsibility for the way you use the app i.e. You need to
				make sure that your device stays charged – if it runs out of
				battery and you can’t turn it on to avail the Service, Jose
				Albizures cannot accept responsibility.
			</p>
			<p>
				With respect to Jose Albizures’s responsibility for your use
				...
				you. Jose Albizures accepts no liability for any loss, direct
				or indirect, you experience as a result of relying wholly on
				this functionality of the app.
			</p>
			<p>
				At some point, we may wish to update the app. The app is
				currently available on – the requirements for the system(and
				for any additional systems we decide to extend the
				availability of the app to) may change, and you’ll need to
				download the updates if you want to keep using the app. Jose
				Albizures does not promise that it will always update the app
				so that it is relevant to you and/or works with the version
			...
			<p>These terms and conditions are effective as of 2022-10-01</p>
			<p>
